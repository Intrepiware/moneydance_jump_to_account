...
## Phase 1: Moneybot Console Script Functionality
...
- [ ] Register the python script as a Moneydance Extension, so the user doesn't have to run this from the Moneybot console everytime.

## Phase 3: Nice-to-Haves

- [ ] Improve filtering to multi-word search instead of simple substring
- [ ] Impelement double-click functionality
